...
public class SeedData
{
    ...
    {
        DbContextOptionsBuilder<SpeakUpContext> dbContextBuilder = new DbContextOptionsBuilder<SpeakUpContext>();
        dbContextBuilder.UseSqlServer(configuration["SpeakUpDbConnectionString"]);

        var context = new SpeakUpContext(dbContextBuilder.Options);
